...
/*
 * The goal of this file is to setup a client to interact with the System
 * The system will be waiting for new data on UDP port 50,001. This data is 
 ...
 * The command sequence will be simple. The user will enter either '-c' or '-d' followed by
 * the remainder of the command infomation. 
*/
